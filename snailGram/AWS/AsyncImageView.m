...
@property (nonatomic, strong) LoadingAnimationView * customActivityView;
...
@synthesize customActivityView = _customActivityView;
...
-(void)enableCustomActivityIndicator {
    int size = MIN(90, self.frame.size.width);
    _customActivityView = [[LoadingAnimationView alloc] initWithFrame:CGRectMake(0, 0, size, size)];
    [_customActivityView setCenter:self.center];
    [_customActivityView startCompleteAnimation];
}
...
- (void)setImage:(UIImage *)image
{
    ...
    if (_customActivityView)
        [_customActivityView removeFromSuperview];
}
